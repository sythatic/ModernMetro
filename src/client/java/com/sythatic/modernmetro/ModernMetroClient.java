...
public class ModernMetroClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        FabricLoader.getInstance().getModContainer("modernmetro").ifPresent(container -> {
            ResourceManagerHelper.registerBuiltinResourcePack(Identifier.of("shader-support", "shader-support"), container, Text.literal("Shader Support"), ResourcePackActivationType.NORMAL);
        });
